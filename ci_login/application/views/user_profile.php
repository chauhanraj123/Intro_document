...
<div class="container">
  <div class="row">
    <div class="col-md-4">
      ...
      <table class="table table-bordered table-striped" style="margin-top: 130px; margin-left: 400px;" >
...
<a href="<?php echo base_url('user/user_logout');?>" >  <button type="button" style="margin-left: 400px; width:31%; background-color:green" class="btn-primary">Logout</button></a>
</div>
  </body>
</html>
